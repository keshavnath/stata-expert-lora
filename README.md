...
The dataset used for fine-tuning is also available: [keshavnath/stata-code-explanations](https://huggingface.co/datasets/keshavnath/stata-code-explanations)
